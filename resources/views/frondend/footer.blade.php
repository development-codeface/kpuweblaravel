                ...
                <div class="cta-area">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                      <div class="footer-widget widget-nav-menu wow fadeInUp" data-wow-delay=".3s">
                          ...
                          <div class="footer-text">
                              ...
                              <p>0484 359 2320/ 700</p>
                          </div>
                          <div class="footer-text">
                              <h5 class="title">Email</h5>
                              <p>info@kpuhospital.com</p>
                          </div>
                      </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-6">
                  ...
                  <div class="col-xl-2 col-lg-4 col-md-6">
                      <div class="footer-widget widget-nav-menu wow fadeInUp" data-wow-delay=".5s">
                          ...
                          <ul>
                              <li><a href="{{ route('ambulance.index') }}">ambulance</a></li>
                              <li><a href="{{ route('blood_bank.index') }}">blood bank</a></li>
                              <li><a href="{{ route('directors.index') }}">directors</a></li>
                              <li><a href="{{ url('doctors') }}">doctors</a></li>
                              <li>
                                  <a href="{{ route('health_packages.index') }}">health packages</a>
                              </li>
                          </ul>
                      </div>
                  </div>
