                    ...
                    <tbody>
                        @foreach ($doctors as $key => $doctor)
                            <tr>
                                ...
                                <td>
                                      <form action="{{ route('admin.doctor.status.change', $doctor->id) }}" method="POST">
                                        @csrf
                                        <button type="submit" onclick="return confirm('Change banner status?')"
                                            class="btn btn-sm {{ $doctor->status == 'active' ? 'btn-success' : 'btn-danger' }}">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        {{-- @can('user_edit') --}}
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.doctor.edit',$doctor->id) }}">
                                            <!-- {{ trans('global.edit') }}  -->
