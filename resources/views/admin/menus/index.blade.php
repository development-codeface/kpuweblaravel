...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p> <i class="fi fi-br-list mr_15_icc"></i> Menus {{ trans('global.list') }}
                {{-- @can('user_create') --}}
            </p>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                    ...
                    <tbody>
                        @foreach ($menu_locations as $value)
                            <tr>
                                <td>{{ $value->name }}</td>
                                <td>
                                    <span class="badge bg-success text-success-fg">{{  $value->status }}</span>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.menus.items',$value->id) }}">
