    ...
    <div class="card">
        <div class="card-header">
            <p><i class="fi fi-br-edit mr_15_icc"></i>
                {{ __('Edit') }}  {{ trans('cruds.career.title_singular') }} </p>
        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        ...
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST" action="{{ route('admin.career.update.banner', $id) }}"
                        ...
                        <div class="tab-pane fade" id="content_Section" role="tabpanel">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST" action="{{ route('admin.career.update.content',$id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="pages_id" value="{{ $id }}">
                                                @php
                                                    ...
                                                    } elseif (isset($content_edit) && $content_edit->count() > 0) {
                                                        $rows = $content_edit;
                                                    } else {
                                                        $rows = collect([
                                                            [
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="icon[]"
                                                                            value="{{ is_array($row) ? $row['icon'] : $row->icon }}"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="mid_title[]"
                                                                            value="{{ is_array($row) ? $row['mid_title'] : $row->title }}"
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="job_type[]"
                                                                            value="{{ is_array($row) ? $row['job_type'] : $row->job_type }}"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="work_mode[]"
                                                                            value="{{ is_array($row) ? $row['work_mode'] : $row->work_mode }}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="location[]"
                                                                            value="{{ is_array($row) ? $row['location'] : $row->location }}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="salary_min[]"
                                                                            value="{{ is_array($row) ? $row['salary_min'] : $row->salary_min }}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="salary_max[]"
                                                                            value="{{ is_array($row) ? $row['salary_max'] : $row->salary_max }}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="salary_type[]"
                                                                            value="{{ is_array($row) ? $row['salary_type'] : $row->salary_type }}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
