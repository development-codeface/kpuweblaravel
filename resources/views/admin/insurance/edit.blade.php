    ...
    <div class="card">
        <div class="card-header">
            <p><i class="fi fi-br-edit mr_15_icc"></i>
                {{ __('Edit') }} {{ trans('cruds.insurance.title_singular') }} </p>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="bannerSection" role="tabpanel">
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    <hr>
                                    <form method="POST" action="{{ route('admin.insurance.update', $edit_banner->id) }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                                                        id="description" rows="6">{{ old('description', $edit_banner->description ?? '') }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST" action="{{ route('admin.insurance.content.update',$edit_content->id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="pages_id" value="{{ $id }}">
                                                ...
                                                <div id="feature-wrapper">
                                                    @php
                                                        if (old('icon')) {
                                                            $subContents = collect(old('icon'))->map(function (
                                                                $icon,
                                                                $index,
                                                            ) {
                                                                return (object) [
                                                            ...
                                                            $subContents = $edit_content->subContents;
                                                        } else {
                                                            $subContents = collect([
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="content_descriptions[]" rows="2"
                                                                            class="form-control {{ $errors->has('content_descriptions.' . $index) ? 'is-invalid' : '' }}">{{ $row->description }}</textarea>
