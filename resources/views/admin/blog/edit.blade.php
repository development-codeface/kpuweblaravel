...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.blog.post.update',$edit->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}">
                                ...
                                @foreach ($category as $cat)
                                    <option value="{{ $cat->id }}"
                                        {{ old('category', $edit->blog_category_id ?? '') == $cat->id ? 'selected' : '' }}>
                                        {{ $cat->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text"
                                name="title" id="title" value="{{ old('title', $edit->title) }}">
                            @if ($errors->has('title'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('title') }}
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="image-box" onclick="document.getElementById('image').click();">
                                ...
                                <img src="{{ asset($edit->image) }}" id="imagePreview" style="width:100%; display:block;">
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="editor"
                                rows="6">{{ old('content', $edit->content) }}</textarea>
