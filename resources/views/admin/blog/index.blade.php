...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p> <i class="fi fi-br-list mr_15_icc"></i> Post {{ trans('global.list') }}
                {{-- @can('user_create') --}}
            </p>
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success " href="{{ route('admin.blog.post.create') }}">
                        <i class="fi fi-br-plus-small mr_5"></i>
                        {{ trans('global.add') }} Post
                    </a>
                </div>
            </div>
            {{-- @endcan --}}
                    ...
                    <tbody>
                        @foreach ($blog as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset($value->image )}}" style="width:80px;height:50px;object-fit:cover;">
                                </td>
                                <td>
                                    {{ $value->title  }}
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        {{-- @can('user_edit') --}}
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.blog.post.edit',$value->id) }}">
                                            <!-- {{ trans('global.edit') }}  -->
