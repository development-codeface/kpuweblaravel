    ...
    <div class="card">
        <div class="card-header">
            <p><i class="fi fi-br-edit mr_15_icc"></i>
                {{ __('Edit') }} {{ trans('cruds.director.title_singular') }} </p>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="bannerSection" role="tabpanel">
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    <hr>
                                    <form method="POST" action="{{ route('admin.directors.update', $edit_banner->id) }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="image-box"
                                                        ...
                                                        @if (!empty($edit_banner) && !empty($edit_banner->image))
                                                            {{-- Show Existing Image --}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST" action="{{ route('admin.directors.blog.update', $edit_content->id ?? '') }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div id="feature-wrapper">
                                                    ...
                                                    @php
                                                        $items = old('heading')
                                                            ...
                                                            : $edit_content->directorBlog ?? collect();
                                                        ...
                                                        <div class="feature-row border p-3 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="heading[]"
                                                                    value="{{ is_array($item) ? $item['heading'] : $item->heading }}"
                                                            ...
                                                            <div class="form-group mt-2">
                                                                ...
                                                                <input type="text" name="designation[]"
                                                                    value="{{ is_array($item) ? $item['designation'] : $item->designation }}"
