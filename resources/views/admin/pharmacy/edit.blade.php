                        ...
                        <div class="tab-pane fade show active" id="bannerSection" role="tabpanel">
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    <hr>
                                    <form method="POST" action="{{ route('admin.pharmacy.update', $edit_banner->id) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="image-box"
                                                        ...
                                                        <div class="triangle-placeholder" id="trianglePlaceholder"
                                                            style="{{ !empty($edit_banner->image) ? 'display:none;' : '' }}">
                                                        </div>

                                                        <img id="imagePreview"
                                                            src="{{ !empty($edit_banner->image) ? asset($edit_banner->image) : '' }}"
                                                            style="{{ !empty($edit_banner->image) ? '' : 'display:none;' }} width:200px;">
                                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        ...
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST" action="{{ route('admin.pharmacy.content.update', $id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="pages_id" value="{{ $id }}">
                                                ...
                                                <div id="feature-wrapper">
                                                    @php
                                                        if (old('icon')) {
                                                            $icons = old('icon');
                                                            $names = old('heading');
                                                            $descs = old('sub_description');
                                                        } elseif (
                                                            isset($edit_sub_content) &&
                                                            $edit_sub_content->count()
                                                        ) {
                                                            $icons = $edit_sub_content->pluck('icon')->toArray();
                                                            $names = $edit_sub_content->pluck('heading')->toArray();
                                                            $descs = $edit_sub_content->pluck('description')->toArray();
                                                        } else {
                                                            $icons = [''];
                                                            $names = [''];
                                                            $descs = [''];
                                                    ...
                                                    @foreach ($icons as $index => $icon)
                                                        <div class="feature-row border p-3 mb-3">
                                                            <input type="hidden" name="content_id[]"
                                                                value="{{ $edit_sub_content[$index]->id ?? '' }}">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="sub_description[]" rows="2"
                                                                            class="form-control {{ $errors->has('sub_description.' . $index) ? 'is-invalid' : '' }}">{{ $descs[$index] ?? '' }}</textarea>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        ...
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST" action="{{ route('admin.pharmacy.plan.update', $id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="pages_id" value="{{ $id }}">
                                                <div id="content-wrappers">
                                                    @php
                                                        if (old('basic_plan')) {
                                                            $basicPlans = old('basic_plan');
                                                            $standardPlans = old('standard_plan');
                                                        } elseif (
                                                            isset($edit_plans_content) &&
                                                            $edit_plans_content->count()
                                                        ) {
                                                            $basicPlans = $edit_plans_content
                                                                ->pluck('basic_plan')
                                                                ->toArray();
                                                            $standardPlans = $edit_plans_content
                                                                ->pluck('standard_plan')
                                                                ->toArray();
                                                        } else {
                                                            $basicPlans = [''];
                                                    ...
                                                    @foreach ($basicPlans as $index => $basic)
                                                        <div class="feature-row">
                                                            <input type="hidden" name="plan_content_id[]"
                                                                value="{{ $edit_plans_content[$index]->id ?? '' }}">
                                                ...
                                                <div id="feature-wrappers">
                                                    @php
                                                        if (old('title')) {
                                                            $titles = old('title');
                                                            $sub_titles = old('sub_title');
                                                            $from_times = old('from_time');
                                                            $to_times = old('to_time');
                                                        } elseif (isset($edit_plans) && $edit_plans->count()) {
                                                            $titles = $edit_plans->pluck('title')->toArray();
                                                            $sub_titles = $edit_plans->pluck('sub_title')->toArray();
                                                            $from_times = $edit_plans->pluck('from_time')->toArray();
                                                            $to_times = $edit_plans->pluck('to_time')->toArray();
                                                        } else {
                                                            $titles = $sub_titles = $from_times = $to_times = [''];
                                                        }
                                                    @endphp
