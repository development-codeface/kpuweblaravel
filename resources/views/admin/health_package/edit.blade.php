    ...
    <div class="card">
        <div class="card-header">
            <p><i class="fi fi-br-edit mr_15_icc"></i>
               {{ __('Edit') }} {{ trans('cruds.health_package.title_singular') }} </p>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="bannerSection" role="tabpanel">
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    <hr>
                                    <form method="POST" action="{{ route('admin.health_packages.update', $edit_banner->id) }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="section-wrapper">
                                        <div class="section-item border p-3 mb-3">
                                            <form method="POST"
                                                action="{{ route('admin.health_packages.content.update', $edit_content->id ?? '') }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="pages_id" value="{{ $id }}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}"
                                                                type="text" name="title" placeholder="Enter title"
                                                                id="title" value="{{ old('title', $edit_content->title ?? '') }}">
                                                            @if ($errors->has('title'))
                                                                <div class="invalid-feedback">
                                                                    {{ $errors->first('title') }}
                                                                </div>
...
{{--
                                                ...
                                                <div id="content-wrapper">
                                                    ...
                                                    @php
                                                        $titles = is_array(old('blog_title'))
                                                            ? old('blog_title')
                                                            : [''];
                                                        $sub_titles = is_array(old('sub_titles'))
                                                            ? old('sub_titles')
                                                            : [''];
