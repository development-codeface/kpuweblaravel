...
<head>
    ...
    <!--cstm css vishnu -->
    <link href="{{ asset('css/vendor/chartist/css/chartist.min.css') }}" rel="stylesheet" />
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="#">
            <span class="navbar-brand-full"><img class="" style="width: 63%;" src="{{ asset('assets/images/logos/kpu-logo1.png') }}" alt="">
        ...
        <ul class="navbar-nav header-right">
            <!-- <li class="nav-item mr_tr"> Kollam - {{ auth()->user()->region_id }}</li> -->
            <!-- <li class="nav-item">
            ...
            <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                    <img src="{{ asset('css/img/17.jpg') }}" width="20" alt="" />
